...
// 9.2.1 Який з цих прикладів є невірним зразком створення та ініціалізації змінної:
 ...
 //2. var b = 10;
// 3. const c = "20";
 //4. d = function(){};  -   є невірним зразком створення та ініціалізації змінної
// 
// 
...
// 2. ==
// 3. &&
// 4. ===  - оператор строгого порівняння
// 5. EQ
// 
// 
// 9.2.4 Який з цих виразів є помилковим?
// 
// 1. x * y == z - є помилковим
// 2. x + y = z
// 3. x = y + (z = i / (k = m * n))
// 
// 
...
// 
// 1. Отримання назви типу? так
// 2. Отримання посилання на констуктор? ні
// 
// 
// 9.2.8 Які з цих прикладів є невірним використанням оператора умовного присвоєння?
// 
// 1. var y = x := z | m; - невірним
// 2. var y = x : z ? m; -невірним
// 3. var y = x ? z : m;
// 
// 
// 
...
// 
// 1. "str1" + "str2"
// 2. "str1" ~ "str2"   зроблена з помилкою
// 3. "str1".concat("str2")
